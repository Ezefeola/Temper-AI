...
description: >
  ...
  Include, ExecuteUpdateAsync) — those belong to `backend/dotnet/orms/ef-core/query-best-practices/SKILL.md`.
...
- Task is purely about EF Core query behavior (tracking, includes, async materialization) → load `backend/dotnet/orms/ef-core/query-best-practices/SKILL.md`
